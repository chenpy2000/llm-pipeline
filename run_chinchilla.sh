...
CONFIGS=(
    ...
    # "512  8  8  2048    33000000    1.6e-3"   # N≈25.2M  (Anchor)
    ...
    # "256  4  8  1024   265000000    4.0e-3"   # N≈3.14M  (Anchor)
    ...
    # "256  4  8  1024    27000000    4.0e-3"   # N≈3.14M  (Anchor)
    ...
    # N ≈ 0.11M (Dense: ~110k), D/N ≈ 6800
    "48   4  4  192     753000000   5.0e-3"
    
    # N ≈ 0.08M (Dense: ~76k), D/N ≈ 14200
    "40   4  4  160    1085000000   5.1e-3"
    
    # N ≈ 0.05M (Dense: ~49k), D/N ≈ 34500
    "32   4  4  128    1695000000   5.2e-3"
