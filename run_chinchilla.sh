...
CONFIGS=(
    ...
    "512  8  8  2048    33000000    8.0e-4"
    "512  8  8  2048    33000000    1.2e-3"
    "512  8  8  2048    33000000    1.6e-3"

    # ═══ MINI-SWEEP: Medium Model (N ≈ 3.14M) ═══
    # Expected to need a slightly higher LR
    "256  4  8  1024    53000000    1.5e-3"
    "256  4  8  1024    53000000    2.0e-3"
    "256  4  8  1024    53000000    2.5e-3"

    # ═══ MINI-SWEEP: Small Model (N ≈ 0.55M) ═══
    # Smallest capacity, expected to tolerate the highest LR
    "96   5  3  384   1506000000    2.5e-3"
    "96   5  3  384   1506000000    3.5e-3"
